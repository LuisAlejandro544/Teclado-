# Carpeta de Paquetes Comprimidos (zips/) 📦

Esta carpeta está monitoreada por el GitHub Action **`.github/workflows/apply-zips.yml`**.

### ¿Cómo funciona?
1. Sube cualquier archivo comprimido (`.zip`, `.7z`, `.tar.gz`, `.tar.bz2`, `.rar`, etc.) dentro de esta carpeta `zips/` en tu repositorio.
2. El flujo de trabajo se activará automáticamente al detectar cambios en esta ruta.
...
4. El archivo comprimido será procesado y eliminado de `zips/` tras la sincronización para evitar bucles.
